...
public class ItemsServiceImpl implements ItemsService{
	...
	public void updateItems(Integer id, ItemsCustom itemsCustom) throws Exception {
		...
		itemsMapper.updateItemsById(itemsCustom);
	}
	...
	public void deleteItems(Integer id, ItemsCustom itemsCustom) throws Exception {
		// TODO Auto-generated method stub
		itemsCustom.setId(id);
		itemsMapper.deleteItemsById(itemsCustom);
		
	}

	@Override
	public void deleteItemsByIdList(List dellist) throws Exception {
		// TODO Auto-generated method stub
		itemsMapperCustom.deleteItemsByIdList(dellist);
