...
//	}
	...
	public String editItemsSubmit(
		...
		if(items_pic!=null && originalFilename!=null && originalFilename.length()>0){
			...
			//存储图片的物理路径
			String pic_path = "G:\\购物网站框架\\imags\\";
	...
	// 批量删除 商品信息
	@RequestMapping("/deleteItemsByIdList")
	public String deleteItems(Integer[] ids) throws Exception {
        ...
        itemsService.deleteItemsByIdList(dellist);
		return "success";
...
//	}
	...
	public String deleteItemById(Model model,HttpServletRequest request,Integer id,ItemsCustom itemsCustom) throws Exception
	{
		itemsService.deleteItems(id, itemsCustom);
